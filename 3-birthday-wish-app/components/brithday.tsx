      ...
      >
        ...
        <Card className="mx-auto overflow-hidden transition-all duration-300 ease-in-out hover:shadow-xl border-2 border-black">
          ...
          <CardHeader className="text-center">
            <CardTitle className="text-4xl font-bold text-red-500">Happy 20th Birthday!</CardTitle>
            <CardDescription className="text-2xl font-semibold text-red-500">Neha Shahzad</CardDescription>
            <p className="text-lg text-red-600">October 11</p>
          </CardHeader>
